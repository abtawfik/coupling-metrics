...
#gfortran -O3 -ffree-line-length-none -c ../../mixing_diagram/"$type"/mixing_diagram.f90
...
gfortran -O0 -g -Wall -fbounds-check -fbacktrace -ffree-line-length-none -c ../../convect_trigger_pot/"$type"/ctp_hilow.f90
...
gfortran -O0 -g -Wall -fbounds-check -fbacktrace -ffree-line-length-none -c ../../mixing_diagram/"$type"/mixing_diagram.f90
gfortran -O0 -g -Wall -fbounds-check -fbacktrace -ffree-line-length-none -c ../../soil_moisture_memory/"$type"/soil_moisture_memory.f90
gfortran -O0 -g -Wall -fbounds-check -fbacktrace -ffree-line-length-none -c ../../terrestrial_coupling_index/"$type"/terrestrial_coupling.f90
